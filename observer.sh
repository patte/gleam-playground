...
# IO.inspect(Node.connect(:'hello-gleam-solitary-smoke-4455-01J8JV6D0D6PG8VQHNDA843GBJ@fdaa:0:1834:a7b:aebf:2103:79f2:2'), label: \"Node Connected?\"); IO.inspect(Node.list(), label: \"Connected Nodes\");
iex --erl "-proto_dist inet6_tcp" --sname hellogleam --cookie ${COOKIE} -e "IO.inspect(Node.connect(:'${FULL_NODE_NAME}'), label: \"Node Connected?\"); IO.inspect(Node.list(), label: \"Connected Nodes\"); :observer.start"
